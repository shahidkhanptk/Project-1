...
<li><a href="{{ route('branch.amount') }}">Add Balance</a></li>
<li><a href="{{ route('amount.show') }}">View Balance</a></li>
</ul>
</li>
<li class="nav-label">Branch Account</li>
<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
...
<ul aria-expanded="false">
<li><a href="{{ route('expense.donation') }}">Expenses</a></li>
<li><a href="{{ route('expense.donation') }}">Donation</a></li>
</ul>
</li>
